...
public class DataManager {
    ...
    public static double calculateTotalPlayerScore(Player player) {
        ...
        totalGames += runnerGames * 0.5; // 轻微补偿局数避免胜率畸高
